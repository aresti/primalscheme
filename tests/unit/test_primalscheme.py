...
def test_process_fasta_length_difference_over_500(input_fasta_length_difference_over_500):
...
def test_process_fasta_chikv_demo(input_fasta_chikv):
    references = process_fasta(input_fasta_chikv)
