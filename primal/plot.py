...
def plot_schemeadelica(prefix, results, reference, path='./'):
    ...
    for r in results:
        cols1 = [reference.id, r.candidate_pairs[0].left.start,
                 r.candidate_pairs[0].left.end, r.candidate_pairs[0].left.name, r.pool]
        cols2 = [reference.id, r.candidate_pairs[0].right.end,
